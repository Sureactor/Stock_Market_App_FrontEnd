...
export class ViewchartComponent implements OnInit{
 ...
 .subscribe((res:any)=>{
   ...
   this.fetch=this.http.get("http://localhost:8080/user/stockexchange/get")
 .subscribe((res:any)=>{
   console.log(res);
     res.forEach(element => {
       this.stockexchanges.push(element.stockExchangeId+ "-"+element.brief);
     }
   )}
   )
 ...
 myfunc()
 {
  ...
  this.fetch=this.http.get("http://localhost:8080/user/company/getbysectorexchange/"+this.sectorId+"/"+this.exchangeId)
  .subscribe((res:any)=>{
    console.log(res); 
    if(this.counter==0)
  ...
  fetchCompanyData(){
    var data;
    var i=0;
    this.fetch2 = this.http.get("http://localhost:8080/user/company/"+this.company1Id+"/"+this.cmpmodel.from+"/"+this.cmpmodel.to)
    .subscribe((res:any)=>{
      console.log(res);
        this.company = res;
        this.message2 = null;
      ...
      var j=0;
      this.fetch3 = this.http.get("http://localhost:8080/user/company/"+this.company2Id+"/"+this.cmpmodel.from+"/"+this.cmpmodel.to)
